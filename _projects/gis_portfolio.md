...
<div class="row justify-content-center">
    <div class="col-8">
        {% include figure.liquid loading="eager" path="assets/img/gis/glanpfires.jpg" title="Glacier National Park Fire Severity" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
...
<div class="row justify-content-center">
    <div class="col-8">
        {% include figure.liquid loading="eager" path="assets/img/gis/granitemountainglacier.jpg" title="Granite Mountain Glacier" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
